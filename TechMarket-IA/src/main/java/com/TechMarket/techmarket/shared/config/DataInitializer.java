...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        log.info(
                "Seed completo: admin@gmail.com, ambassador={}, referrals+commissions+opportunities+missions creados.",
                ambassadorId);
    }
        ...
        List<CommissionSeed> seeds =
                List.of(
                        ...
                        new CommissionSeed(
                                ...
                                "SOFTWARE",
                                "LEVEL1",
                                now.minusWeeks(2).plusDays(3)),
                        new CommissionSeed(
                                r2, "890.00", "RENEWAL", "SOFTWARE", "LEVEL1", now.minusDays(4)),
                        ...
                        new CommissionSeed(
                                ...
                                "SOFTWARE",
                                "LEVEL1",
                                now.minusWeeks(2).plusDays(1)),
                        new CommissionSeed(
                                r4, "820.00", "RENEWAL", "SOFTWARE", "LEVEL1", now.minusDays(5)),
                        ...
                        new CommissionSeed(
                                ...
                                "SERVICES",
                                "LEVEL2",
                                now.minusWeeks(3).plusDays(3)),
                        new CommissionSeed(
                                r5, "600.00", "RENEWAL", "SERVICES", "LEVEL2", now.minusDays(6)),
                        ...
                        new CommissionSeed(
                                ...
                                "SOFTWARE",
                                "LEVEL2",
                                now.minusWeeks(4).plusDays(2)),
                        new CommissionSeed(
                                r6, "695.00", "RENEWAL", "SOFTWARE", "LEVEL2", now.minusWeeks(2)),
                        new CommissionSeed(
                                r6, "730.00", "RENEWAL", "SOFTWARE", "LEVEL2", now.minusDays(3)),
                        ...
                        new CommissionSeed(
                                ...
                                "HARDWARE",
                                "LEVEL2",
                                now.minusMonths(2).plusDays(12)),
                        new CommissionSeed(
                                r7, "430.00", "RENEWAL", "HARDWARE", "LEVEL2", now.minusWeeks(3)),
                        new CommissionSeed(
                                r7, "465.00", "RENEWAL", "HARDWARE", "LEVEL2", now.minusWeeks(1)),
                        ...
                        new CommissionSeed(
                                ...
                                "HARDWARE",
                                "LEVEL3",
                                now.minusWeeks(2).plusDays(2)),
                        new CommissionSeed(
                                r8, "370.00", "RENEWAL", "HARDWARE", "LEVEL3", now.minusDays(7)),
                        ...
                        new CommissionSeed(
                                ...
                                "SERVICES",
                                "LEVEL3",
                                now.minusMonths(1).plusDays(6)),
                        new CommissionSeed(
                                r9, "310.00", "RENEWAL", "SERVICES", "LEVEL3", now.minusWeeks(2)),
                        new CommissionSeed(
                                r9, "335.00", "RENEWAL", "SERVICES", "LEVEL3", now.minusDays(2)));
    ...
    private void seedOpportunities(UUID ambassadorId, OffsetDateTime now) {
        List<AmbassadorOpportunityJpaEntity> opps =
                List.of(
                        opportunity(
                                ambassadorId,
                                "HARDWARE",
