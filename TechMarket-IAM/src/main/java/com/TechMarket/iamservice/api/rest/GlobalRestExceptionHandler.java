...
import com.techmarket.core.shared.exceptions.BusinessRuleViolationException;
import com.techmarket.core.shared.exceptions.DomainException;
...
public class GlobalRestExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleEntityNotFoundException(
        ...
        return handleTechMarketException(ex, HttpStatus.NOT_FOUND, request, webRequest);
    }
    ...
    public ResponseEntity<ErrorResponse> handlePermissionDeniedException(
        ...
        return handleTechMarketException(ex, HttpStatus.FORBIDDEN, request, webRequest);
    }
    ...
    public ResponseEntity<ErrorResponse> handleBusinessRuleViolationException(
        ...
        return handleTechMarketException(ex, HttpStatus.CONFLICT, request, webRequest);
    }

    @ExceptionHandler(DomainException.class)
    public ResponseEntity<ErrorResponse> handleDomainException(
            DomainException ex, HttpServletRequest request, WebRequest webRequest) {
        return handleTechMarketException(ex, HttpStatus.BAD_REQUEST, request, webRequest);
    }
    ...
    public ResponseEntity<ErrorResponse> handleTechMarketException(
            TechMarketException ex, HttpServletRequest request, WebRequest webRequest) {
        return handleTechMarketException(ex, HttpStatus.BAD_REQUEST, request, webRequest);
    }

    private ResponseEntity<ErrorResponse> handleTechMarketException(
            TechMarketException ex,
            HttpStatus status,
