...
- `src/test/java/com/TechMarket/iamservice/api/rest/RoleControllerTest.java` (nuevo o completar)
- `src/test/java/com/TechMarket/iamservice/api/rest/AssignPermissionsToRoleControllerTest.java` (nuevo o completar)
