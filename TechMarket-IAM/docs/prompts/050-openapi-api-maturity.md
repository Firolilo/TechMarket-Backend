...
- `src/main/java/com/TechMarket/iamservice/config/OpenApiConfig.java` (ya existe, verificar/completar)
- `src/main/java/com/TechMarket/iamservice/api/rest/RoleController.java` (agregar anotaciones OpenAPI)
- `src/main/java/com/TechMarket/iamservice/api/rest/AssignPermissionsToRoleController.java` (agregar anotaciones OpenAPI)
- `src/main/java/com/TechMarket/iamservice/application/dto/CreateRoleRequest.java` (agregar anotaciones OpenAPI)
- `src/main/java/com/TechMarket/iamservice/application/dto/CreateRoleResponse.java` (agregar anotaciones OpenAPI)
- `src/main/java/com/TechMarket/iamservice/application/dto/AssignPermissionsToRoleRequest.java` (agregar anotaciones OpenAPI)
- `src/main/java/com/TechMarket/iamservice/application/dto/AssignPermissionsToRoleResponse.java` (agregar anotaciones OpenAPI)
- `src/main/java/com/TechMarket/iamservice/api/rest/dto/ErrorResponse.java` (agregar anotaciones OpenAPI)
