...
- `src/main/java/com/TechMarket/iamservice/api/rest/RoleController.java`
- `src/main/java/com/TechMarket/iamservice/application/orchestration/CreateRoleOrchestrator.java`
- `src/main/java/com/TechMarket/iamservice/application/dto/CreateRoleRequest.java`
- `src/main/java/com/TechMarket/iamservice/application/dto/CreateRoleResponse.java`
...
- `src/test/java/com/TechMarket/iamservice/api/rest/RoleControllerTest.java` (nuevo)
- `src/test/java/com/TechMarket/iamservice/application/orchestration/CreateRoleOrchestratorTest.java` (nuevo)
