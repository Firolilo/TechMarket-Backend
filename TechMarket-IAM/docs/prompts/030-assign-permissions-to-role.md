...
- `src/main/java/com/TechMarket/iamservice/api/rest/AssignPermissionsToRoleController.java`
- `src/main/java/com/TechMarket/iamservice/application/orchestration/AssignPermissionsToRoleOrchestrator.java` (ya existe, verificar/completar)
- `src/main/java/com/TechMarket/iamservice/application/dto/AssignPermissionsToRoleRequest.java` (ya existe, verificar)
- `src/main/java/com/TechMarket/iamservice/application/dto/AssignPermissionsToRoleResponse.java` (ya existe, verificar)
- `src/main/java/com/TechMarket/iamservice/api/exception/ErrorCodes.java` (agregar códigos)
...
- `src/test/java/com/TechMarket/iamservice/api/rest/AssignPermissionsToRoleControllerTest.java` (nuevo)
- `src/test/java/com/TechMarket/iamservice/application/orchestration/AssignPermissionsToRoleOrchestratorTest.java` (nuevo)
