...
- `src/main/java/com/TechMarket/iamservice/IamServiceApplication.java`
- `src/main/java/com/TechMarket/iamservice/config/UseCaseConfig.java`
...
2. Verifica que IamServiceApplication tenga:
   - @SpringBootApplication con scanBasePackages que incluya "com.techmarket.iamservice" y "com.techmarket.core"
   - @EntityScan para escanear entidades JPA de "com.techmarket.core.iam.domain.model"
   - @EnableJpaRepositories para repositorios de "com.techmarket.core.iam.infrastructure.persistence.repository"
